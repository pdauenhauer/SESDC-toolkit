...
load_demand = [1600, 1200, 1350, 750, 520, 50, 1000, 1000, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 100, 100, 200, 200, 200, 600]
...
ess = EnergyStorageSystem(capacity=500)  # Initializing the energy storage system
...
plt.legend()
plt.title('Cycle Charging Process')
plt.show()
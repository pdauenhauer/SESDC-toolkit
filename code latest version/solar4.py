...
file_path ="C:/Users/danie/Desktop/Senior Design/Codes/myenv/csv/malawi_gumbwa_health_post - Copy.csv"
...
hours_100_solar = calculate_solar_energy(sub_data_raw["Irradiance (W/m2)"], sub_data_raw_solar["Temp_C (oC)"],
                                    panel_name_plate_W=panel_char[0], losses=panel_losses["loss_value"], coef=coef, STCIrr=STCIrr, STCTemp=STCTemp)
...
hourly_solar_data = data_cleaned_solar.head(24)

# Call function for reduced data
hourly_solar_energy = calculate_hourly_solar_energy(data_cleaned_solar, panel_name_plate_W=panel_char[0], losses=panel_losses["loss_value"], coef=coef, STCIrr=STCIrr, STCTemp=STCTemp)
...
hourly_output = calculate_solar_energy(irradiance=1071, ambient_temp_C=39, panel_name_plate_W=panel_char[0], losses=panel_losses["loss_value"], coef=coef, STCIrr=STCIrr, STCTemp=STCTemp)

#print("Hour 1:", hourly_output, "Wh")

...
def csv_processing(req: https_fn.Request) -> https_fn.Response:  
    if req.path == "/__/health":
        return https_fn.Response("OK", status=200) 
    
    if req.method == "OPTIONS":
        return https_fn.Response("", 204)
    ...
    try:
        ...
        battery_inputs = {"charge_capacity": charge_capacity, "maximum_storage": maximum_storage}
        ...
        solar_inputs = {"losses": losses, "solar_array_size": solar_array_size}
        ...
        run_simulation(userId, projectId, battery_inputs, solar_inputs, wind_inputs, df)
...
def fetch_solar_data(location_inputs, battery_inputs, solar_inputs, wind_inputs, userId, projectId, api_key="TC1RGLjNIwUJrOGGyPvg4Fgq182jznjbbeIfZT5f", year="2022", interval="30"):
    ...
    if response.status_code == 200:
        ...
        run_simulation(userId, projectId, battery_inputs, solar_inputs, wind_inputs, new_df)
    else:
...
def fetch_solar_data_function(req: https_fn.Request) -> https_fn.Response:
    ...
    location_inputs = {"latitude": latitude, "longitude": longitude}
    ...
    fetch_solar_data(location_inputs, battery_inputs, solar_inputs, wind_inputs, userId, projectId)
    
    return https_fn.Response("Data fetched successfully")

def run_simulation(userId, projectId, battery_inputs, solar_inputs, wind_inputs, df):
    ...
    print(solar_plot_path)
    print(load_plot_path)
    print(wind_plot_path)
    print(net_energy_plot_path)
    print(diesel_plot_path)
    print(net_bat_plot_path)
    print(net_kw_path)
